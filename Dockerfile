...
RUN sed -i 's/archive/old-releases/g' /etc/apt/sources.list && \
	...
	echo -e "rpcuser=$(base64 /dev/urandom | fold -w 80 | base64 | head -n 1)\nrpcpassword=$(base64 /dev/urandom | base64 | fold -w 80 | head -n 1)" > /home/bitstarcoin/.bitstarcoin/bitstarcoin.conf && \
